    ...
    <section ref={containerRef} className="py-24 overflow-hidden relative">
      ...
      <div className="w-full flex">
        <motion.div style={{ x }} className="flex gap-6 px-6 cursor-grab active:cursor-grabbing">
          {images.map((img, i) => (
            <div key={i} className="min-w-[300px] md:min-w-[500px] aspect-[4/3] rounded-3xl overflow-hidden bg-gray-900 border border-white/10 group">
              <img 
                src={img} 
          ...
          {images.map((img, i) => (
            <div key={`dup-${i}`} className="min-w-[300px] md:min-w-[500px] aspect-[4/3] rounded-3xl overflow-hidden bg-gray-900 border border-white/10 group">
              <img 
                src={img} 
